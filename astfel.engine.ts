...
namespace AstFel.GameEngine {
    ...
    export class Camera2D {
        ...
        point(): Point2D {
            return new AstFel.GameEngine.Point2D(this.x, this.y);
        }

        distanceToPoint(point:AstFel.GameEngine.Point2D):number{
    ...
    */
    ...
    export class Geometry {
        ...
        getTriangle(face:AstFel.GameEngine.Face):Array<AstFel.GameEngine.Point3D>{
    ...
    export class Face {
        ...
        b:number;
        c:number;
        faceVertexUvs: Array<Array<AstFel.GameEngine.UV>>;
        constructor(a:number,b:number,c:number){
            this.faceVertexUvs = Array<Array<AstFel.GameEngine.UV>>();
            this.a = a;
            this.b = b;
            this.c = c;
        }
        addVertexUvs(uvs:Array<AstFel.GameEngine.UV>){
    ...
    */
    ...
    export class NocEntityBase {
        ...
        drawTriangle(context: CanvasRenderingContext2D, 
                verticles: Array<AstFel.GameEngine.Point3D>,) {
